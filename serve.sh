...
docker run -p 35729:35729 -p 4000:4000 -it --rm -v $(PWD):/data -w /data --entrypoint '["/bin/bash", "-c", "bundle update && bundle exec jekyll serve -H 0.0.0.0  --livereload"]' compgen/jtd-docker:latest
